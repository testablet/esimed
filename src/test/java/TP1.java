...
public class TP1 {
    ...
    public void exo5()
    {
        ...
        Assertions.assertArrayEquals(new String[]{"One", null, null, null, null}, application.read5Words(reader));
        reader = FileReader.fromString("One. Two");
        Assertions.assertArrayEquals(new String[]{"One", "Two", null, null, null}, application.read5Words(reader));
        reader = FileReader.fromString("One.\n Two");
        Assertions.assertArrayEquals(new String[]{"One", "Two", null, null, null}, application.read5Words(reader));
        reader = FileReader.fromString("One.\r Two");
        Assertions.assertArrayEquals(new String[]{"One", "Two", null, null, null}, application.read5Words(reader));
        reader = FileReader.fromString(".");
        Assertions.assertArrayEquals(new String[]{null, null, null, null, null}, application.read5Words(reader));
        reader = FileReader.fromString("");
        Assertions.assertArrayEquals(new String[]{null, null, null, null, null}, application.read5Words(reader));
        reader = new FileReader("BellumCivile.txt");
        Assertions.assertArrayEquals(new String[]{"ad", "ea", "Caesar", "respondit", "nulli"}, application.read5Words(reader));
    }
    ...
    @Test
    public void exo7() {
        Assertions.assertEquals(0, TextFileTools.countWords(FileReader.fromString(""),""));
        Assertions.assertEquals(0, TextFileTools.countWords(FileReader.fromString(""),"one"));
        Assertions.assertEquals(0, TextFileTools.countWords(FileReader.fromString("ONe"),"one"));
        Assertions.assertEquals(1, TextFileTools.countWords(FileReader.fromString("ONe"),"ONe"));
        Assertions.assertEquals(2, TextFileTools.countWords(FileReader.fromString("ONe two one Two ONe"),"ONe"));
    }
    ...
    public void exo8() throws IOException {
        ...
        TextFileTools.walkDirectory("textes", new ProcessFile() {
            ...
            public void process(Path fileName) {
                if (!first[0]) {
                    Assertions.assertEquals("textes/code_de_procedure_penale/57-1.txt", fileName.toString());
                    first[0] = true;
                } else if (!first[1]) {
                    Assertions.assertEquals("textes/code_de_procedure_penale/97-1.txt", fileName.toString());
                    first[1] = true;
                }
            }
        });
